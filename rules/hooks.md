...
React-specific rules in this file are grounded in the official React documentation. Nino-specific rules define application-state boundaries and are additional project constraints.
...
The project's official React Hooks linting rules MUST be enabled and MUST NOT be disabled or weakened to make an implementation pass.
...
Nino-specific application-state rules in this file are project constraints and are not presented as React requirements.

When a React rule and a Nino-specific state rule address different concerns, both apply.
